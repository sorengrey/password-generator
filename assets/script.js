...
// Sets the user's inputs to false so the while loop can start the prompts over if the user doesn't choose a character set
var lowCase = false;
var upCase = false;
var numCase = false;
var symCase = false;
    
// Loops through four questions until the user confirms at least one
...
if (lowCase === false && upCase === false && numCase === false && symCase === false){
    // Validation alert
